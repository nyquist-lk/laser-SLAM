...
if("TRUE" STREQUAL "TRUE")
  set(open_karto_SOURCE_PREFIX /media/nlk/D/share/code/slam/激光SLAM/2D/karto/open_karto)
  set(open_karto_DEVEL_PREFIX /media/nlk/D/share/code/slam/激光SLAM/2D/karto/open_karto/build/devel)
  ...
  set(open_karto_INSTALL_PREFIX /usr/local)
...
if(NOT "/media/nlk/D/share/code/slam/激光SLAM/2D/karto/open_karto/include;/usr/include " STREQUAL " ")
  set(open_karto_INCLUDE_DIRS "")
  set(_include_dirs "/media/nlk/D/share/code/slam/激光SLAM/2D/karto/open_karto/include;/usr/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'Michael Ferguson <mfergs7@gmail.com>, Russell Toris <rtoris@fetchrobotics.com>, Luc Bettaieb <lbettaieb@fetchrobotics.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'open_karto' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/media/nlk/D/share/code/slam/激光SLAM/2D/karto/open_karto/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /media/nlk/D/share/code/slam/激光SLAM/2D/karto/open_karto/build/devel/lib;/opt/ros/melodic/lib)
