...
examples/CMakeFiles/rosenbrock.dir/rosenbrock.cc.o: ../examples/rosenbrock.cc
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/media/nlk/D/share/code/slam/激光SLAM/2D/cartographer-latest/ceres-solver/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object examples/CMakeFiles/rosenbrock.dir/rosenbrock.cc.o"
	cd /media/nlk/D/share/code/slam/激光SLAM/2D/cartographer-latest/ceres-solver/build/examples && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/rosenbrock.dir/rosenbrock.cc.o -c /media/nlk/D/share/code/slam/激光SLAM/2D/cartographer-latest/ceres-solver/examples/rosenbrock.cc
...
examples/CMakeFiles/rosenbrock.dir/rosenbrock.cc.i: cmake_force
	...
	cd /media/nlk/D/share/code/slam/激光SLAM/2D/cartographer-latest/ceres-solver/build/examples && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /media/nlk/D/share/code/slam/激光SLAM/2D/cartographer-latest/ceres-solver/examples/rosenbrock.cc > CMakeFiles/rosenbrock.dir/rosenbrock.cc.i
...
examples/CMakeFiles/rosenbrock.dir/rosenbrock.cc.s: cmake_force
	...
	cd /media/nlk/D/share/code/slam/激光SLAM/2D/cartographer-latest/ceres-solver/build/examples && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /media/nlk/D/share/code/slam/激光SLAM/2D/cartographer-latest/ceres-solver/examples/rosenbrock.cc -o CMakeFiles/rosenbrock.dir/rosenbrock.cc.s
...
bin/rosenbrock: examples/CMakeFiles/rosenbrock.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/media/nlk/D/share/code/slam/激光SLAM/2D/cartographer-latest/ceres-solver/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable ../bin/rosenbrock"
	cd /media/nlk/D/share/code/slam/激光SLAM/2D/cartographer-latest/ceres-solver/build/examples && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/rosenbrock.dir/link.txt --verbose=$(VERBOSE)
