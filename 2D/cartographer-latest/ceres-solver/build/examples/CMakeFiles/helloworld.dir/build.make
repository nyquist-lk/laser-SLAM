...
examples/CMakeFiles/helloworld.dir/helloworld.cc.o: ../examples/helloworld.cc
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/media/nlk/D/share/code/slam/激光SLAM/2D/cartographer-latest/ceres-solver/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object examples/CMakeFiles/helloworld.dir/helloworld.cc.o"
	cd /media/nlk/D/share/code/slam/激光SLAM/2D/cartographer-latest/ceres-solver/build/examples && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/helloworld.dir/helloworld.cc.o -c /media/nlk/D/share/code/slam/激光SLAM/2D/cartographer-latest/ceres-solver/examples/helloworld.cc
...
examples/CMakeFiles/helloworld.dir/helloworld.cc.i: cmake_force
	...
	cd /media/nlk/D/share/code/slam/激光SLAM/2D/cartographer-latest/ceres-solver/build/examples && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /media/nlk/D/share/code/slam/激光SLAM/2D/cartographer-latest/ceres-solver/examples/helloworld.cc > CMakeFiles/helloworld.dir/helloworld.cc.i
...
examples/CMakeFiles/helloworld.dir/helloworld.cc.s: cmake_force
	...
	cd /media/nlk/D/share/code/slam/激光SLAM/2D/cartographer-latest/ceres-solver/build/examples && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /media/nlk/D/share/code/slam/激光SLAM/2D/cartographer-latest/ceres-solver/examples/helloworld.cc -o CMakeFiles/helloworld.dir/helloworld.cc.s
...
bin/helloworld: examples/CMakeFiles/helloworld.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/media/nlk/D/share/code/slam/激光SLAM/2D/cartographer-latest/ceres-solver/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable ../bin/helloworld"
	cd /media/nlk/D/share/code/slam/激光SLAM/2D/cartographer-latest/ceres-solver/build/examples && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/helloworld.dir/link.txt --verbose=$(VERBOSE)
